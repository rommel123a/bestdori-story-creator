...
| 3 人 | `leftInside` + `center` + `rightInside` | 0 / 0 / 0 |
| 4 人 | `leftInside`×2 + `rightInside`×2 | **-100 / 0 / 0 / +100** |
| 5 人 | `left`×2 + `center` + `right`×2 | -200 / 0 / 0 / 0 / +200 |

### 动态进出场（N→N+1 过渡）

**关键原则：新人出现前，先 shift 旧人腾位。**

```
3人→4人示例：
  Phase 1: Soyo(leftInside 0)  Taki(center 0)  Tomori(rightInside 0)
  Phase 2: Soyo move 0→-100    Taki move center→leftInside 0
  Phase 3: Anon appear rightInside +100  →  四人对称居中对齐
  Phase 4: Taki/Tomori hide → Soyo move -100→0, Anon move +100→0  →  回到2人
```
